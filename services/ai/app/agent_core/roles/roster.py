    ...
    return {
        "retrieval": RoleDefinition(
            ...
            default_reasoning_params=RoleReasoningDefaults(
                risk_level="low", min_iterations=1, max_iterations=3, temperature=0.1
            ),
        ...
        "interpretation": RoleDefinition(
            ...
            default_reasoning_params=RoleReasoningDefaults(
                risk_level="medium", min_iterations=2, max_iterations=3, temperature=0.2
            ),
        ...
        "simulation_planning": RoleDefinition(
            ...
            default_reasoning_params=RoleReasoningDefaults(
                risk_level="medium", min_iterations=2, max_iterations=4, temperature=0.2
            ),
        ...
        "composition": RoleDefinition(
            ...
            tool_grant_ceiling=(),
            default_reasoning_params=RoleReasoningDefaults(
                risk_level="low", min_iterations=1, max_iterations=2, temperature=0.4
            ),
