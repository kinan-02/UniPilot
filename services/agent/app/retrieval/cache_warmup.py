...
def warmup_retrieval_caches(
    *,
    ...
    try:
        from app.agent.evaluation.wiki_eval_cache import warm_wiki_eval_cache

        warm_wiki_eval_cache(settings=cfg)
    except Exception:  # noqa: BLE001 — eval cache is optional
        pass
    return resolved
