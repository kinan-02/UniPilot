...
from app.agent.reasoning.schema_repair import run_schema_repair_loop
...
from app.agent.reasoning.tracing import log_reasoning_trace
from app.agent.reasoning.debug_observer import ReasoningBlockDebugObserver, current_eval_debug_context
...
class ReasoningBlock:
    ...
    def _emit_debug_observer(
        ...
        *,
        ...
        tracker = current_eval_llm_tracker()
