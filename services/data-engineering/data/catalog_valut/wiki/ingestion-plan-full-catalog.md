...
**Target wiki pages (estimated):** 800–1,300  
**Ingestion depth:** Level A (full) — faculty entity + track pages + individual course pages for all units  

Read this file at every session start to know where we are and what's next.
...
| **Part D — Faculty 01** | הנדסה אזרחית וסביבתית (Civil & Environmental Engineering) | 73–95 | ☐ pending |
| **Part D — Faculty 02** | הנדסת מכונות (Mechanical Engineering) | 96–103 | ☐ pending |
| **Part D — Faculty 03** | הנדסת חשמל ומחשבים (Electrical & Computer Engineering) | 104–129 | ☐ pending |
| **Part D — Faculty 04** | הנדסה כימית (Chemical Engineering) | 130–139 | ☐ pending |
| **Part D — Faculty 05** | הנדסת ביוטכנולוגיה ומזון (Biotechnology & Food Engineering) | 140–145 | ☐ pending |
| **Part D — Faculty 06** | הנדסת אוירונוטיקה וחלל (Aerospace Engineering) | 146–155 | ☐ pending |
| **Part D — Faculty 07** | מדעי הנתונים וההחלטות (DDS) | 156–168 | ✅ DONE (from DDS catalog) |
| **Part D — Faculty 08** | מתמטיקה (Mathematics) | 169–178 | ☐ pending |
| **Part D — Faculty 09** | פיזיקה (Physics) | 179–193 | ☐ pending |
| **Part D — Faculty 10** | כימיה (Chemistry) | 194–205 | ☐ pending |
| **Part D — Faculty 11** | ביולוגיה (Biology) | 206–216 | ☐ pending |
| **Part D — Faculty 12** | ארכיטקטורה ובינוי ערים (Architecture & Town Planning) | 217–228 | ☐ pending |
| **Part D — Faculty 13** | חינוך למדע וטכנולוגיה (Education in Science & Technology) | 229–245 | ☐ pending |
| **Part D — Faculty 14** | מדעי המחשב (Computer Science) | 246–269 | ☐ pending |
| **Part D — Faculty 15** | רפואה (Medicine) | 270–288 | ☐ pending |
| **Part D — Faculty 16** | מדע והנדסה של חומרים (Materials Science & Engineering) | 289–299 | ☐ pending |
| **Part D — Dept 17** | לימודים הומניסטיים ואמנויות (Humanities & Arts) | 300–301 | ☐ pending |
| **Part D — Faculty 18** | הנדסה ביו-רפואית (Biomedical Engineering) | 302–312 | ☐ pending |
| **Part D — Inter 01** | מתמטיקה שימושית (Applied Mathematics) | 313 | ☐ pending |
| **Part D — Inter 02** | ננו-מדעים וננו-טכנולוגיה (Nano Science & Technology) | 314 | ☐ pending |
| **Part D — Inter 03** | ביוטכנולוגיה (Biotechnology, interdisciplinary) | 315 | ☐ pending |
| **Part D — Inter 04** | הנדסת פולימרים (Polymer Engineering) | 316 | ☐ pending |
| **Part D — Inter 05** | הנדסת תכן וניהול הייצור (Design & Production Management) | 317 | ☐ pending |
| **Part D — Inter 06** | הנדסת מערכות (Systems Engineering) | 318 | ☐ pending |
| **Part D — Inter 07** | אנרגיה (Energy) | 319–320 | ☐ pending |
| **Part D — Inter 08** | מערכות אוטונומיות ורובוטיקה (Autonomous Systems & Robotics) | 321 | ☐ pending |
| **Part D — Inter 09** | הנדסה עירונית (Urban Engineering) | 322 | ☐ pending |
| **Part D — Inter 10** | הנדסה ימית (Naval Engineering) | 323–325 | ☐ pending |
...
**Phases completed:** Phase 0 ✅, Phase 1 ✅, Phase 3 ✅  
**Next step:** Phase 2 (faculty ingestion) — start with Batch A (pages 73–155)
