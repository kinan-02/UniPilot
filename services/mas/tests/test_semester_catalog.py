...
from app.services.semester_catalog import (
    ...
    semester_filename_for_plan_code,
)
...
def test_semester_filename_for_plan_code_roundtrip():
    filename = "courses_2025_201.json"
    plan_code = plan_semester_code_from_filename(filename)
    assert semester_filename_for_plan_code(plan_code) == filename
