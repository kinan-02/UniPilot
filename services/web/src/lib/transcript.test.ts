...
describe('transcript utilities', () => {
  it('computes transcript stats', () => {
    ...
    expect(stats.averageGrade).toBe(77.5)
  ...
  it('groups records by semester newest first', () => {
    const groups = groupTranscriptBySemester([
      sampleRecord({ id: '1', semesterCode: '2023-2' }),
      sampleRecord({ id: '2', semesterCode: '2024-1', courseNumber: '00940411' }),
      sampleRecord({ id: '3', semesterCode: '2024-1', courseNumber: '00940345' }),
    ])
