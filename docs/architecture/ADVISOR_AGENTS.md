...
Related: `docs/architecture/ARCHITECTURE.md` (platform containers), `docs/planning/AGENT_FEATURES_ROADMAP.md` (future agent features), `services/ai/app/services/advisor_agent.py`, `services/ai/app/services/profile_agent.py`, `services/ai/app/services/planning_agent.py`, `services/ai/app/services/regulation_agent.py`.
