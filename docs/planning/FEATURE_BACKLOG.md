...
| AI-2 | Internal AI service integration | P0 | 3 | in-progress |
...
| AI-7 | AI response validation + timeouts/retries | P0 | 3 | in-progress |
...
| DEC-2 | "What-if" academic scenario analysis | P1 | 4 | done |
| DEC-3 | Decision history per student | P2 | 4 | todo |

**Agentic expansion (detailed specs):** `docs/planning/AGENT_FEATURES_ROADMAP.md` — sub-agents, async jobs, simulation council, watchdog, etc.
